...
void LexicalAnalyzer::initSymbols(){
...
//constructor
LexicalAnalyzer::LexicalAnalyzer(const string& source): input(source), position(0){
    initKeywords();
    initSymbols();
}
...
string LexicalAnalyzer::getTokenTypeName(TokenType type) {
    switch (type) {
        //keywords
        case TokenType::FN:
            return "FN";
